...
const Chip = styled.span<{ color: string; bg: string; border: string }>`
  display: inline-flex;
  align-items: center;
  gap: 0.35rem;
...
/* ── Severity Section ───────────────────────────────────── */
const SevDetails = styled.details<{ color: string; bg: string; border: string }>`
  border: 1px solid ${p => p.border};
...
const SevSummary = styled.summary<{ color: string }>`
  display: flex;
  align-items: center;
  gap: 0.6rem;
...
const FindingItem = styled.li<{ color: string }>`
  display: grid;

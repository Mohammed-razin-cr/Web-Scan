...
console.log(
  `\n\x1b[1m\x1b[35m Preparing to start build of WebScan.... \x1b[0m\n`,
  `\x1b[35m\x1b[2mCompiling for "${deployTarget}" using "${output}" mode, ` +
    `to deploy to "${site}" at "${base}"\x1b[0m\n`,
  `\x1b[2m\x1b[36mFor documentation and support, visit the GitHub profile: ` +
    `https://github.com/Mohammed-razin-cr/ \n`,
  `WebScan intelligence platform initialized.\x1b[0m\n`,
);
